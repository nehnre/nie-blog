        ...
        <td width="722" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td height="67" background="/images/index_11.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="95%" align="left"  class="hotText">
					<?php if(is_array($listHot)): $i = 0; $__LIST__ = $listHot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): ++$i;$mod = ($i % 2 )?>&nbsp;<?php if($i > 1): ?>|<?php endif; ?>&nbsp;<a href="/index.php/Article/detail?blar_id=<?php echo ($vo1["blar_id"]); ?>" class="whiteText"><?php echo ($vo1["blar_title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
				</td>
                <td width="3%">&nbsp;</td>
              </tr>
            </table></td>
          ...
          <tr class="contentmodel">
            <td  background="/images/index_16.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td colspan="2">&nbsp;</td>
                <td align="left" class="content"><?php echo ($vo["blar_content"]); ?></td>
                <td>&nbsp;</td>
              </tr>
            </table></td>
          </tr>
            ...
            <td  background="/images/index_22.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="91%" align="left" class="readtop10">
					<?php if(is_array($listOrder)): $i = 0; $__LIST__ = $listOrder;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): ++$i;$mod = ($i % 2 )?><div><a href="/index.php/Article/detail?blar_id=<?php echo ($order["blar_id"]); ?>"><?php echo ($order["blar_title"]); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
				</td>
                <td width="3%">&nbsp;</td>
              </tr>
            </table></td>
